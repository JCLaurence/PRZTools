...
namespace NCC.PRZTools
{
    public class PlanningUnitsVM : PropertyChangedBase
    {
        ...
        private async Task<bool> ProcessNationalDbTables(PlanningUnitLayerType puLayerType, CancellationToken token)
        {
            bool edits_are_disabled = !Project.Current.IsEditingEnabled;
            int val = PM.Current;
            int max = PM.Max;
            ...
            try
            {
                ...
                string fldElemPresence = PRZC.c_FLD_TAB_NATELEMENT_PRESENCE + " SHORT 'Presence' # 2 '" + PRZC.c_DOMAIN_PRESENCE + "';";
                ...
                string fldThemePresence = PRZC.c_FLD_TAB_NATTHEME_PRESENCE + " SHORT 'Presence' # 2 '" + PRZC.c_DOMAIN_PRESENCE + "';";
